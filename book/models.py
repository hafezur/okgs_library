...
class Category(models.Model):
    ...
    category_image=models.ImageField(upload_to='photo/category_image',blank=True,null=True)
...
class BookStoreModel(models.Model):
    ...
    book_image = models.ImageField(upload_to='book_photo',blank=True,null=True)
